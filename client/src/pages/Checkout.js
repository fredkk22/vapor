              ...
              <div className="row g-3">
                <div className="col-sm-6">
                  ...
                  <div className="input-group has-validation">
                    <input type="text" className="form-control" id="firstName" placeholder="First" required=""></input>
                ...
                <div className="col-sm-6">
                  ...
                  <div className="input-group has-validation">
                    <input type="text" className="form-control" id="lastName" placeholder="Last" required=""></input>
                    <div className="invalid-feedback">
                ...
                <div className="col-12">
                  <label for="address2" class="form-label">Address 2 <span className="text-muted">(Optional)</span></label>
